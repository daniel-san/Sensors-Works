...
.LVL2:
	.loc 1 62 0
	ldi r24,lo8(__c.1943)
	ldi r25,hi8(__c.1943)
	rcall uart_puts_p
.LVL3:
.LBB10:
.LBB11:
	.file 2 "/usr/avr/include/stdlib.h"
	.loc 2 428 0
	ldi r20,lo8(10)
	movw r22,r28
	subi r22,-1
...
.LVL8:
	...
	rjmp .L3
	.loc 1 103 0
	ldi r24,lo8(__c.1945)
	ldi r25,hi8(__c.1945)
	rcall uart_puts_p
.LVL9:
.L3:
	.loc 1 105 0
	...
	rjmp .L4
	.loc 1 112 0
	ldi r24,lo8(__c.1947)
	ldi r25,hi8(__c.1947)
	rcall uart_puts_p
.LVL10:
.L4:
	.loc 1 114 0
	...
	rjmp .L5
	.loc 1 120 0
	ldi r24,lo8(__c.1949)
	ldi r25,hi8(__c.1949)
	rcall uart_puts_p
.LVL11:
.L5:
	.loc 1 125 0
...
.LFE5:
	...
	.type	__c.1949, @object
	.size	__c.1949, 24
__c.1949:
	.string	"Buffer overflow error: "
	.type	__c.1947, @object
	.size	__c.1947, 21
__c.1947:
	.string	"UART Overrun Error: "
	.type	__c.1945, @object
	.size	__c.1945, 19
__c.1945:
	.string	"UART Frame Error: "
	.type	__c.1943, @object
	.size	__c.1943, 24
__c.1943:
